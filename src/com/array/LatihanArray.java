...
public class LatihanArray {
    public static void main(String[] args) {
        ...
        System.out.println("~~~~Penggabungan dari arrayAngka1 dan arrayAngka2~~~~");
        printArray(arrayAngka1, "array 1");
        printArray(arrayAngka2, "array 2");
        printArray(arrayHasil2, "hasil 2");

        // sorting reverse, menguruskan tapi kebalik
        System.out.println("Pengurutan dari yang terbesar arrayAngka1: ");
        printArray(arrayAngka1, "array 1");
        reverse(arrayAngka1);
        printArray(arrayAngka1, "reverse 1");

        System.out.println("Pengurutan dari yang terbesar arrayAngka2: ");
        printArray(arrayAngka2, "array 2");
        reverse(arrayAngka2);
